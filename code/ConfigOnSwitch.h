// this is copied practically verbatim from ConfigOnSwitch.ino
// See https://github.com/khoih-prog/ESP_WiFiManager/blob/master/examples/ConfigOnSwitch/ConfigOnSwitch.ino
// Renamed setup() to setup2()
// Renamed loop() to loop2()
// this way I can include this complicated code easily in my own project
// There I will include it as a .h file
// and call setup2() and loop2() from inside my own setup function
// I replaced the trigger buttons by a bool bOpenPortal flag which I will use to enter the portal from my own project
// changed default timeout of 60000mS in line 507 in ESP_WiFiManager-Impl.h -> int connRes = WiFi.waitForConnectResult(2500); // 2.5 seconds

bool bOpenPortal = false;
...
//    ESP.reset();
//#else
//    ESP.restart(); // makes no sense if wrong credentials are stored
//#endif  
  }
...
void setup2() // was void setup()
{
  // put your setup code here, to run once:
  // initialize the LED digital pin as an output.

// commented out - will use bOpenPortal boolean
...
//  pinMode(TRIGGER_PIN2, INPUT_PULLUP);
  ...
  ssid.toUpperCase();
//password = "My" + ssid;
  password =""; // no password on portal itself
  ...
  if (initialConfig) // nothing configured yet
  { TFT_line_print(5, "Use Your Smartphone And Connect To JUKEBOX-PORTAL For Your Wifi Setup");
    ...
    saveConfigData();
    TFT_line_print(5, "Configuration Done");
    delay(2500);
  }
  ...
  { 
    ...
    if ( WiFi.status() != WL_CONNECTED ) 
    { TFT_line_print(1, "SSID");
      TFT_line_print(2, Router_SSID.c_str());
      TFT_line_print(3, "PASSWORD");
      TFT_line_print(4, "********");
  ...
  if (WiFi.status() == WL_CONNECTED)
  { TFT_line_print(5, "Wifi Ok");
    Serial.print(F("connected. Local IP: "));
    Serial.println(WiFi.localIP());
  }
  else
  { TFT_line_print(5, "Wifi Fail");
    Serial.println(ESP_wifiManager.getStatus(WiFi.status()));
  }  
}

void loop2() // void loop()
{
